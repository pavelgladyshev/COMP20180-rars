...
public class ControlAndStatusWindow extends RegisterBlockWindow {
    ...
    private static final String[] regToolTips = {
            /*mstatus"*/ "Interrupt status information (set the lowest bit to enable exceptions)",
            /*fflags*/ "The accumulated floating point flags",
            /*frm*/    "Rounding mode for floating point operatations",
            /*fcsr*/   "Both frm and fflags",
            /*mie*/    "Finer control for which interrupts are enabled",
            /*mtvec*/  "The base address of the interrupt handler",
            /*mscratch*/"Scratch for processing inside the interrupt handler",
            /*mepc*/   "PC at the time the interrupt was triggered",
            /*mcause*/ "Cause of the interrupt (top bit is interrupt vs trap)",
            /*mtval*/  "Value associated with the cause",
            /*mip*/    "Shows if any interrupt is pending and what type",
